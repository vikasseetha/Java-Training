...
public class RgtMessaging {
	 ...
	 * @param bio
	 * @return
	 * @If user Already exists throws UserAlreadyExistsException
	 */
	 ...
	 * @param password
	 * @return
	 * @If User is not found throws UserNotFoundException
	 */
	...
	/**
	 * This is method is used to unFollow the user with userName
	 * 
	 * @param username
	 * @return
	 */
	...
	/**
	 * This method is used to get the Profile details of particular person we login
	 * 
	 * @param username
